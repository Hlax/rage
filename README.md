...
**Live staged network proofs** (operator opt-in; tickets 167–172): pytest proofs on
...
proofs stop before `extract-claims`; ticket-172 adds mock-fixture extract after live
ingest (`staged_fetch_extract_claims.json`).

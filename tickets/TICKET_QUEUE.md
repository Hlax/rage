...
| 276 | ticket-276 | proposed | Operator proof bundle export JSON stable on CLI second run | | |
...
```txt
ticket-276 (proposed) — Operator proof bundle export JSON stable on CLI second run

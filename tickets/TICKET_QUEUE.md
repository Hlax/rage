...
| 402 | ticket-402 | proposed | AGENTS.md execute-safe OpenAI evaluator seed hook cross-link v0 | | |
...
```txt
ticket-402 (proposed) — AGENTS.md execute-safe OpenAI evaluator seed hook cross-link v0
```

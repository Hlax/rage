...
| 195 | ticket-195 | proposed | Fix live staged pytest candidate ordering column | | |
...
```txt
ticket-195 (proposed) — Fix live staged pytest candidate ordering column
(ticket-059 OpenAI placeholder remains deferred)
```

## Queue Notes (2026-06-15, ticket-194 agent)
